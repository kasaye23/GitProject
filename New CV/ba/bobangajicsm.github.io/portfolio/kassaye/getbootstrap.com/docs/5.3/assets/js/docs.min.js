...
! function(e, t) {
    ...
    return n = {
        686: function(e, t, n) {
            ...
            function f(e, t) {
                var n, s, e = (s = e, n = "rtl" === document.documentElement.getAttribute("dir"), (e = document.createElement("textarea")).style.fontSize = "12pt", e.style.border = "0", e.style.padding = "0", e.style.margin = "0", e.style.position = "absolute", e.style[n ? "right" : "left"] = "-9999px", n = window.pageYOffset || document.documentElement.scrollTop, e.style.top = "".concat(n, "px"), e.setAttribute("readonly", ""), e.value = s, e);
            ...
            s = function(e) {
                var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {
                    ...
                    t = "";
                return "string" == typeof e ? t = f(e, n) : e instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(e ? .type) ? t = f(e.value, n) : (t = a()(e), r("copy")), t
            };
            ...
            function v(e) {
                ...
                return function() {
                    var n, s = l(e);
                    return n = t ? (n = l(this).constructor, Reflect.construct(s, arguments, n)) : s.apply(this, arguments), s = this, !(n = n) || "object" !== o(n) && "function" != typeof n ? function(e) {
            ...
            p = function() {
                ...
                function e(t, n) {
                    ...
                    }(this), (s = r.call(this)).resolveOptions(n), s.listenClick(t), s
                }
                return t = e, n = [{
                    key: "copy",
                    value: function(e) {
        ...
        370: function(e, t, n) {
            ...
            e.exports = function(e, t, n) {
                ...
                if (s.node(e)) return c = t, l = n, (d = e).addEventListener(c, l), {
                    destroy: function() {
                        d.removeEventListener(c, l)
                    }
                };
                if (s.nodeList(e)) return i = e, a = t, r = n, Array.prototype.forEach.call(i, function(e) {
        ...
        279: function(e) {
            ...
            t.prototype = {
                ...
                emit: function(e) {
                    for (var s = [].slice.call(arguments, 1), n = ((this.e || (this.e = {}))[e] || []).slice(), t = 0, o = n.length; t < o; t++) n[t].fn.apply(n[t].ctx, s);
                    return this
                },
                off: function(e, t) {
                    var n, a, o = this.e || (this.e = {}),
                        s = o[e],
                        i = [];
                    if (s && t)
    ...
    document.querySelectorAll(".highlight").forEach(e => {
        e.closest(".bd-example-snippet") || (e.insertAdjacentHTML("beforebegin", o), e.previousElementSibling.append(e))
    });
    ...
    window.docsearch({
        ...
        transformItems(e) {
            return e.map(e => {
                ...
                return e.url = window.location.origin.startsWith(t) ? e.url : e.url.replace(t, "/"), e.anchor === "content" && (e.url = e.url.replace(/#content$/, ""), e.anchor = null), e
            })
        }
    })
})(), (() => {
