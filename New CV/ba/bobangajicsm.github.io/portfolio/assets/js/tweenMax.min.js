                        ...
                        if (this._time !== o && this._first || c || i || l) {
                            ...
                            this._onUpdate && (b || (j.length && k(),
                                ...
                                h && (this._gc || (p === this._startTime || q !== this._timeScale) && (0 === this._time || n >= this.totalDuration()) && (f && (j.length && k(),
                                    ...
                                    this._active = !1), !b && this.vars[h] && this._callback(h)))
                        }
                    },
                    ...
                    k.render = function(a, b, c) {
                        ...
                        this._onUpdate && (b || (g.length && h(),
                            ...
                            j && (this._locked || this._gc || (s === this._startTime || t !== this._timeScale) && (0 === this._time || o >= this.totalDuration()) && (f && (g.length && h(),
                                this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                                this._active = !1), !b && this.vars[j] && this._callback(j)))
                    },
                    ...
                    ya("borderRadius", {
                        ...
                        parser: function(a, b, c, f, g, h) {
                            ...
                            for (q = parseFloat(a.offsetWidth),
                                ...
                                m = l = _(a, y[j], e, !1, "0px"), -1 !== m.indexOf(" ") && (l = m.split(" "),
                                    m = l[0],
                                    l = l[1]),
                                n = k = i[j],
                                o = parseFloat(m),
                    ...
                    j._onInitTween = function(a, b, h, j) {
                        ...
                        if (l && "" === A.zIndex && (n = _(a, "zIndex", e),
                            ...
                            "string" == typeof b && (t = A.cssText,
                                n = ca(a, e),
                                A.cssText = t + ";" + b,
                                n = da(a, n, ca(a)).difs, !U && y.test(b) && (n.opacity = parseFloat(RegExp.$1)),
                                b = n,
                                A.cssText = t),
                                ...
                                "color" === g || "fill" === g || "stroke" === g || -1 !== g.indexOf("Color") || s && A.test(n) ? (s || (n = na(n),
                                    ...
                                    o !== p && "" !== p && (l || 0 === l) && j && (j = aa(a, g, j, o),
                                        "%" === p ? (j /= aa(a, g, 100, "%") / 100,
                                            ...
                                            p = "px"),
                                        t && (l || 0 === l) && (n = l + j + p)),
                                    t && (l += j), !j && 0 !== j || !l && 0 !== l ? void 0 !== u[g] && (n || n + "" != "NaN" && null != n) ? (c = new ta(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n),
                    ...
                    this.check = function(j) {
                            ...
                            if (0 === t && g) {
                                if (m = ("com.greensock." + d).split("."),
                                    ...
                                    h)
                                    if (e[n] = c[n] = o,
                                        p = "undefined" != typeof module && module.exports, !p && "function" == typeof define && define.amd)
